...
// Map of uinput code names to uinput codes
const map<const string, int> Maps::uinputKeyMap = Maps::setupKeyMap();

// Map of control codes to Strings
const cec_code_map Maps::cecUserControlCodeName = Maps::setupUserControlCodeName();

// Map of cec to uinput codes from the config file
std::map<const __u16, list<__u16>> Maps::uinputCecMap = Maps::setupUinputMap();

const map<const string, int> Maps::setupKeyMap() {
...
const cec_code_map & Maps::setupUserControlCodeName() {
  static cec_code_map cecUserControlCodeName;

  if (cecUserControlCodeName.empty()) {
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SELECT, "SELECT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_UP, "UP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_DOWN, "DOWN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_LEFT, "LEFT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_RIGHT, "RIGHT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_RIGHT_UP, "RIGHT_UP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_RIGHT_DOWN, "RIGHT_DOWN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_LEFT_UP, "LEFT_UP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_LEFT_DOWN, "LEFT_DOWN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_ROOT_MENU, "ROOT_MENU"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SETUP_MENU, "SETUP_MENU"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_CONTENTS_MENU, "CONTENTS_MENU"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_FAVORITE_MENU, "FAVORITE_MENU"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_EXIT, "EXIT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER0, "NUMBER0"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER1, "NUMBER1"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER2, "NUMBER2"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER3, "NUMBER3"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER4, "NUMBER4"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER5, "NUMBER5"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER6, "NUMBER6"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER7, "NUMBER7"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER8, "NUMBER8"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NUMBER9, "NUMBER9"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_DOT, "DOT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_ENTER, "ENTER"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_CLEAR, "CLEAR"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_NEXT_FAVORITE, "NEXT_FAVORITE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_CHANNEL_UP, "CHANNEL_UP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_CHANNEL_DOWN, "CHANNEL_DOWN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PREVIOUS_CHANNEL, "PREVIOUS_CHANNEL"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SOUND_SELECT, "SOUND_SELECT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_INPUT_SELECT, "INPUT_SELECT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_DISPLAY_INFORMATION, "DISPLAY_INFORMATION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_HELP, "HELP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PAGE_UP, "PAGE_UP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PAGE_DOWN, "PAGE_DOWN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_POWER, "POWER"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_VOLUME_UP, "VOLUME_UP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_VOLUME_DOWN, "VOLUME_DOWN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_MUTE, "MUTE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PLAY, "PLAY"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_STOP, "STOP"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PAUSE, "PAUSE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_RECORD, "RECORD"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_REWIND, "REWIND"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_FAST_FORWARD, "FAST_FORWARD"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_EJECT, "EJECT"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_FORWARD, "FORWARD"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_BACKWARD, "BACKWARD"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_STOP_RECORD, "STOP_RECORD"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PAUSE_RECORD, "PAUSE_RECORD"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_ANGLE, "ANGLE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SUB_PICTURE, "SUB_PICTURE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_VIDEO_ON_DEMAND, "VIDEO_ON_DEMAND"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_ELECTRONIC_PROGRAM_GUIDE, "ELECTRONIC_PROGRAM_GUIDE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_TIMER_PROGRAMMING, "TIMER_PROGRAMMING"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_INITIAL_CONFIGURATION, "INITIAL_CONFIGURATION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PLAY_FUNCTION, "PLAY_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PAUSE_PLAY_FUNCTION, "PAUSE_PLAY_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_RECORD_FUNCTION, "RECORD_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_PAUSE_RECORD_FUNCTION, "PAUSE_RECORD_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_STOP_FUNCTION, "STOP_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_MUTE_FUNCTION, "MUTE_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_RESTORE_VOLUME_FUNCTION, "RESTORE_VOLUME_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_TUNE_FUNCTION, "TUNE_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SELECT_MEDIA_FUNCTION, "SELECT_MEDIA_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SELECT_AV_INPUT_FUNCTION, "SELECT_AV_INPUT_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_SELECT_AUDIO_INPUT_FUNCTION, "SELECT_AUDIO_INPUT_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_POWER_TOGGLE_FUNCTION, "POWER_TOGGLE_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_POWER_OFF_FUNCTION, "POWER_OFF_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_POWER_ON_FUNCTION, "POWER_ON_FUNCTION"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_F1_BLUE, "F1_BLUE"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_F2_RED, "F2_RED"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_F3_GREEN, "F3_GREEN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_F4_YELLOW, "F4_YELLOW"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_F5, "F5"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_DATA, "DATA"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_AN_RETURN, "AN_RETURN"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_AN_CHANNELS_LIST, "AN_CHANNELS_LIST"));
    cecUserControlCodeName.insert(cec_code_map::relation(CEC_USER_CONTROL_CODE_UNKNOWN, "UNKNOWN"));
  }

  return cecUserControlCodeName;
}

map<const __u16, list<__u16>> Maps::setupUinputMap() {
  static map<const __u16, list<__u16>> configMap;

  set<string> options;
  options.insert("key_mapping.*");
  ifstream config("/etc/libcec-daemon.conf");
  if(!config) {
      //LOG4CPLUS_ERROR(Main::logger, "error loading config file");
  }
  else {
    for(program_options::detail::config_file_iterator iter(config, options), end; iter != end; ++iter) {
      string cec_key = iter->string_key;
      cec_key.erase(0, 12);
      __u16 cec_key_val = Maps::cecUserControlCodeName.right.find(cec_key)->second;
      string uinput_key = iter->value[0];
      __u16 uinput_key_val = Maps::uinputKeyMap.find(uinput_key)->second;
      //LOG4CPLUS_DEBUG(Main::logger, "CEC Key Map: " << cec_key << "(" <<  cec_key_val << ") => "<< uinput_key << "(" << uinput_key_val << ")");
      configMap[cec_key_val].emplace_back(uinput_key_val);
    }
  }
  return configMap;
}
